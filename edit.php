            ...
            <div class="card-body">
                ...
                <form action="" method="post" role="form">
                    ...
                    <div class = "form-group"> 
						...
						<br>
						<img src="up/<?= $row['logo']; ?>" class="col-3">
						 <input type="hidden" name="gambar_sebelumnya" value="<?= $row['logo']; ?>" />
					</div>
					<div class = "form-group"> 
                ...
                if (isset($_POST['submit'])) {
			        ...
			        $foto = $nama_unik1;
					mysqli_query($koneksi, "update barang set nama='$nama', harga='$harga', deskripsi='$deskripsi', logo='$foto' where id ='$id'") or die(mysqli_error($koneksi));
                    echo "<script>alert('data berhasil diupdate.');window.location='indexaddons.php';</script>";
                }
                ?>
            </div>
        </div>
